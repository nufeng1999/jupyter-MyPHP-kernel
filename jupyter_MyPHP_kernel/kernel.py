...
##do_runcode
    def do_runcode(self,return_code,file_name,magics,code, silent, store_history=True,
        ...
        retstr=''
        ##代码运行前
        p = self.mymagics.create_jupyter_subprocess(['php','-f',file_name]+ magics['_st']['args'],cwd=None,shell=False,env=self.mymagics.addkey2dict(magics,'env'),magics=magics)
...
##do_compile_code
    def do_compile_code(self,return_code,file_name,magics,code, silent, store_history=True,
        ...
        retinfo=self.mymagics.get_retinfo()
        retstr=''
        # returncode,binary_filename=self._exec_phpc_(file_name,magics)
